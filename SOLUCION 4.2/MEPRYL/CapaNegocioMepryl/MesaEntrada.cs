...
namespace CapaNegocioMepryl
{
    public class MesaEntrada
    {
        ...
        {
            return mesaEntrada.cargarParametrosReporteExClinico(idConsulta, mail);
        }
        ...
        {
            return mesaEntrada.cargarParametrosReporteHojaRuta(idConsulta, mail);
        }
        ...
        {
            mesaEntrada.RevisarPaciente(IdConsulta, blnEstado);
        }

        public DataTable cargarMesaEntradaPlanilla()
        {
            return mesaEntrada.cargarMesaEntradaPlanilla();
        }
