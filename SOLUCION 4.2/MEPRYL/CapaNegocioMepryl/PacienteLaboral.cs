...
namespace CapaNegocioMepryl
{
    public class PacienteLaboral
    {
        ...
        {
            return pacienteLaboral.MailPacientePorEmpresa(strIdPacienteLaboral, strIdEmpresa);
        }

        public DataTable ListaProfesionalLabora(string strDNI)
        {
            return pacienteLaboral.ListaProfesionalLabora(strDNI);
        }

        public bool EsEmpresaPrincipal(string strIdEmpresa)
        {
            return pacienteLaboral.EsEmpresaPrincipal(strIdEmpresa);
        }

        public string idProfesional(string strDNI)
        {
            return pacienteLaboral.idProfesional(strDNI);
        }

        public DataTable ListaProfesional(string strDNI)
        {
            return pacienteLaboral.ListaProfesional(strDNI);
        }
    }
}
