...
namespace CapaDatosMepryl
{
    public class MesaEntrada
    {
        ...
        public DataTable cargarMesaEntrada()
        {
            ...
            te.id as IdTipoExamen, te.idTurno as IdTurno, c.fecha as Fecha, c.nroOrden as 'Nº Ingreso', c.tipo as Tipo, c.identificador as 'Nº Orden',
        ...
        public DataTable exportarMesaEntrada(DateTime dtDesde, DateTime dtHasta)
        {
            ...
            strSQL = "SELECT CONVERT(DATE, c.fecha, 103) AS 'Fecha', c.identificador AS 'Nro Ex', " +
        ...
        private List<object> cargarDatosPacientePreventiva(Guid idPaciente)
        {
            ...
            fechaNacimiento, telefonos, celular
