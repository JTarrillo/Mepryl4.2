...
namespace CapaDatosMepryl
{
    public class ClubMantenimiento
    {
        ...
        {
            string strSQL = "SELECT TOP 100 C.id, C.codigo, C.ligaID, C.codigoliga, C.descripcion as Club, L.imagen as Imagen ,L.descripcion AS Liga, C.activo, C.pathImagen, C.direccion1, C.direccion2, C.contacto, C.telefono, C.mail, C.urlMapa " + 
