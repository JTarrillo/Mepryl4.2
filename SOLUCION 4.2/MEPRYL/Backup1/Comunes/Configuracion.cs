...
namespace Comunes
{
    public class Conexion
    {
        ...
        {
            string cadena = "SERVER=" + SERVER + ";DATABASE=" + DATABASE;
            if (this.seguridadIntegrada == "SI")
                cadena += ";Integrated Security=SSPI;";
            else
                cadena += ";UID=" + UID + ";PWD=" + PWD + ";";
            return cadena;
        }
    }
    ...
    public class Configuracion
    {
        ...
        {
            string cadena = "SERVER=" + conexion.SERVER + ";DATABASE=" + conexion.DATABASE;
            if (conexion.seguridadIntegrada == "SI")
                cadena += ";Integrated Security=SSPI;";
            else
                cadena += ";UID=" + conexion.UID + ";PWD=" + conexion.PWD + ";";
