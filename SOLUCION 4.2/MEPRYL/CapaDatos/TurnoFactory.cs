...
namespace CapaDatos
{
    public class TurnoFactory : EntidadFactoryBase
    {
        ...
        public override Resultado alta(EntidadBase ent)
        {
            ...
            try
            {
                //Da el alta del registro vac�o para obtener el ID
        ...
        //El alta manda todos los datos en una sola instrucci�n
        ...
        //Lee el registro obtenido de la base de datos, cada implementaci�n agrega los campos espef�cicos.
        ...
        public string obtenerOpcionesHorarias(ref DateTime fecha, EEspecialidad especialidad)
        {
            ...
            try
            {
                ...
                while (!turnoLibreEncontrado)
                {
                    string separador = "";
                    int contador = 0;
                    //Si no encuentra para la fecha, el mismo d�a en la semana pr�xima... as� hasta un mes.
                    ...
                    //Si no se encontr� turno libre, se busca la proxima fecha disponible
        ...
        //Realiza la b�squeda de turnos libres en determinado segmento de fechas y horarios
        // 07/11/2014: Modificado para agregar diferentes especialidades
