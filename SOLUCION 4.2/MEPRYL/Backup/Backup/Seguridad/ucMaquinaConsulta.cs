...
{
	/// <summary>
	/// Summary description for ucMaquinaConsulta.
	/// </summary>
	public class ucMaquinaConsulta : System.Windows.Forms.UserControl
	{
		...
		private System.Windows.Forms.TextBox tbNombreMaquinaB;
		...
		private System.Windows.Forms.TextBox tbMaquinaID;
		private System.Windows.Forms.GroupBox gbModificacion;
		private System.ComponentModel.IContainer components;

		public ucMaquinaConsulta()
		{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(ucMaquinaConsulta));
			...
			this.tbNombreMaquinaB = new System.Windows.Forms.TextBox();
			...
			this.tbMaquinaID = new System.Windows.Forms.TextBox();
			...
			this.tabPage1.Text = "Listado de Máquinas";
			// 
			// pictureBox1
			// 
			...
			this.dgItems.CaptionBackColor = System.Drawing.Color.DarkTurquoise;
			...
			this.dgItems.CaptionText = "     Listado de Máquinas";
			...
			this.dataGridTextBoxColumn11.HeaderText = "Nombre Máquina";
			this.dataGridTextBoxColumn11.MappingName = "Nombre Máquina";
			...
			this.dataGridTextBoxColumn12.HeaderText = "Sucursal";
			this.dataGridTextBoxColumn12.MappingName = "Sucursal";
			...
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.tbNombreMaquinaB);
			this.groupBox1.Location = new System.Drawing.Point(8, 8);
			this.groupBox1.Name = "groupBox1";
			this.groupBox1.Size = new System.Drawing.Size(200, 48);
			this.groupBox1.TabIndex = 1;
			this.groupBox1.TabStop = false;
			this.groupBox1.Text = "Nombre de Maquina";
			// 
			// tbNombreMaquinaB
			// 
			this.tbNombreMaquinaB.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.tbNombreMaquinaB.Location = new System.Drawing.Point(8, 16);
			this.tbNombreMaquinaB.Name = "tbNombreMaquinaB";
			this.tbNombreMaquinaB.Size = new System.Drawing.Size(184, 20);
			this.tbNombreMaquinaB.TabIndex = 1;
			this.tbNombreMaquinaB.Text = "";
			// 
			// tabFiltro3
			// 
			...
			// gbModificacion
			// 
			this.gbModificacion.Controls.Add(this.tbMaquinaID);
			this.gbModificacion.Controls.Add(this.groupBox9);
			this.gbModificacion.Controls.Add(this.butGuardar);
			this.gbModificacion.Controls.Add(this.cbSucursal);
			this.gbModificacion.Controls.Add(this.label1);
			this.gbModificacion.Controls.Add(this.tbNombreMaquina);
			...
			// tbMaquinaID
			// 
			this.tbMaquinaID.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.tbMaquinaID.Location = new System.Drawing.Point(24, 160);
			this.tbMaquinaID.Name = "tbMaquinaID";
			this.tbMaquinaID.Size = new System.Drawing.Size(32, 20);
			this.tbMaquinaID.TabIndex = 236;
			this.tbMaquinaID.Text = "";
			this.tbMaquinaID.Visible = false;
			// 
			// groupBox9
			// 
			...
			this.label18.Text = "     Modificación de Máquinas";
			// 
		...
		private string construirSQL()
		{
			try
			{
				...
				string sql = "SELECT     dbo.Maquina.id, dbo.Maquina.nombre AS [Nombre Máquina], dbo.Maquina.sucursalID, dbo.Maquina.observaciones AS Observaciones, " +
					"RIGHT('00' + RTRIM(LTRIM(CAST(dbo.Sucursal.numero AS char(2)))), 2) + ' - ' + dbo.Sucursal.nombre AS Sucursal " +
					"FROM         dbo.Maquina LEFT OUTER JOIN " +
					"dbo.Sucursal ON dbo.Maquina.sucursalID = dbo.Sucursal.id " +
					"WHERE " + filtro;
		...
		private string obtenerWHERE()
		{
			try
			{
				...
				if (tbNombreMaquinaB.Text!="") 
				{
					filtro = filtro + " AND dbo.Maquina.nombre LIKE '%" + tbNombreMaquinaB.Text.Trim() + "%'";
				}
				if (tbObservacionesB.Text!="") 
				{
					filtro = filtro + " AND dbo.Maquina.observaciones LIKE '%" + tbObservacionesB.Text.Trim() + "%'";
				}
				if (cbSucursalB.SelectedIndex>0) 
				{
					filtro = filtro + " AND dbo.Maquina.sucursalID = CAST('" + cbSucursalB.SelectedValue.ToString() + "' AS uniqueidentifier";
				}
		...
		private void acomodarCombosOrden()
		{
			try
			{
				cbCampoOrden1.SelectedIndex = 1;  //Nombre Maquina
				rbAsc1.Checked = true;
				cbCampoOrden2.SelectedIndex = 3;  //Sucursal
				rbAsc2.Checked = true;
			...
			try
			{
				if (dgItems.DataSource!=null)
					if (((DataTable)dgItems.DataSource).Rows.Count>0)
					{
						...
						tbMaquinaID.Text = dt.Rows[currentRow]["ID"].ToString();
						tbNombreMaquina.Text = dt.Rows[currentRow]["Nombre Máquina"].ToString();
		...
		private bool validarFormulario()
		{
			try
			{
				...
				if (mensaje!="")
				{
					...
					MessageBox.Show(mensaje, "Modificación de Máquinas", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
				}
		...
		private void guardarCambios()
		{
			try
			{
				...
				param[0] = new SqlParameter("@maquinaID", new System.Guid(tbMaquinaID.Text));
				param[1] = new SqlParameter("@nombreMaquina", nombreMaquina);
				param[2] = new SqlParameter("@sucursalID", new System.Guid(sucursalID));
				param[3] = new SqlParameter("@observaciones", observaciones);
			
				while (true)
				{
					try 
					{
						//Modifica el registro en la tabla de Maquinas
						SqlHelper.ExecuteNonQuery(this.conexion, "sp_ModificarMaquina", param);
					
						MessageBox.Show("Máquina modificada con éxito.", "Modificación de Máquinas", MessageBoxButtons.OK, MessageBoxIcon.Information);
						//limpiarCamposUnicos();
						UtilUI.trabajando(this.formContenedor, ref this.statusBarPrincipal, "Máquina modificada con éxito.", false);
						break;
					}
					catch (Exception e)
					{
						ManejadorErrores.escribirLog(e, true);
						DialogResult dr = MessageBox.Show("No se pudo modificar la Máquina. \r\n" + e.Message, "Guardar", MessageBoxButtons.AbortRetryIgnore, MessageBoxIcon.Error);
						UtilUI.trabajando(this.formContenedor, ref this.statusBarPrincipal, "No se pudo modificar la Máquina. \r\n" + e.Message, false);
			...
			try
			{
				if (dgItems.DataSource!=null)
				{
					...
					if (dt.Rows.Count>0)
					{
						...
						if (sRows!="")
						{
							DialogResult dr = MessageBox.Show("¿Desea borrar las Máquinas seleccionadas?", "Borrar", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
							if (dr== DialogResult.Yes)
							{
								UtilUI.trabajando(this.formContenedor, ref this.statusBarPrincipal, "Borrando Máquinas...", true);
								...
								for (int j=0; j<rows.Length; j++)
								{
									...
									SqlHelper.ExecuteNonQuery(this.conexion, "sp_BorrarMaquina", param);
