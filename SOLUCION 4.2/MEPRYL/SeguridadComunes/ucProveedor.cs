...
namespace Comunes
{
	...
	/// </summary>
	public class ucProveedor : System.Windows.Forms.UserControl
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(ucProveedor));
			...
			this.gbModificacionCheques.Controls.Add(this.tbCuit);
			...
			this.gbModificacionCheques.Controls.Add(this.tbRazonSocial);
			...
			this.gbModificacionCheques.TabIndex = 107;
			...
			this.label18.Text = "     Alta de Proveedores";
			// 
			// pictureBox1
			// 
		...
		private void darAlta()
		{
			try
			{
				...
				param[0] = new SqlParameter("@razonSocial", tbRazonSocial.Text);
				param[1] = new SqlParameter("@calle", tbCalle.Text);
				param[2] = new SqlParameter("@telefonos", tbTelefonos.Text);
				param[3] = new SqlParameter("@nro", tbNro.Text);
				param[4] = new SqlParameter("@piso", tbPiso.Text);
				param[5] = new SqlParameter("@oficina", tbOficina.Text);
				param[6] = new SqlParameter("@codigoPostal", tbCodPost.Text);
				param[7] = new SqlParameter("@email", tbEmail.Text);
				param[8] = new SqlParameter("@localidadID", new System.Guid(localidadID));
				param[9] = new SqlParameter("@cuit", tbCuit.Text);
				param[10] = new SqlParameter("@provinciaID", new System.Guid(provinciaID));
				param[11] = new SqlParameter("@notas", tbNotas.Text);

				while (true)
				{
					try 
					{
						SqlHelper.ExecuteNonQuery(this.conexion, "sp_NuevoProveedor", param);
						MessageBox.Show("Proveedor ingresado con éxito.", "Alta de Proveedores", MessageBoxButtons.OK, MessageBoxIcon.Information);
						UtilUI.trabajando(formContenedor, ref this.statusBarPrincipal, "Proveedor ingresado con éxito.", false);
						limpiarCamposUnicos();
						break;
					}
					catch (Exception e)
					{
						...
						DialogResult dr = MessageBox.Show("No se pudo registrar el Proveedor. \r\n" + e.Message, "Guardar", MessageBoxButtons.AbortRetryIgnore, MessageBoxIcon.Error);
						UtilUI.trabajando(formContenedor, ref this.statusBarPrincipal, "No se pudo registrar el Proveedor. \r\n" + e.Message, false);
