...
{
    public partial class frmBaseGrillaABM : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmBaseGrillaABM(ModoApertura modo)
        {
            InitializeComponent();
        ...
        public frmBaseGrillaABM(Configuracion config, ModoApertura modo, frmBasePrincipal parentForm)
        {
            InitializeComponent();
        ...
        //M�todos virtuales
        public virtual void SaludarHolaMundo() { }
        ...
        protected virtual void cargarEspecialidad() { }
        protected virtual void cargarEspecialidad(bool forzarTodos) { cargarEspecialidad(); }
        ...
        protected void recuperarObjetoPorCodigo(string codigo)
        {
            try
            {
                System.Diagnostics.Debug.WriteLine($"[DEBUG-RECUPERAR] Iniciando recuperarObjetoPorCodigo con codigo={codigo}");
                ...
                {
                    rglEntidad = entidadAux;
                    System.Diagnostics.Debug.WriteLine($"[DEBUG-RECUPERAR] rglEntidad.id={rglEntidad.id}, rglEntidad.codigo={rglEntidad.codigo}");
                    mostrarDatosObjeto();
                    System.Diagnostics.Debug.WriteLine($"[DEBUG-RECUPERAR] mostrarDatosObjeto ejecutado");
                    butModificar.Enabled = true;
                    if (this.permisoModificacion)
                        butModificar.Visible = true;
                    if (this.habilitarBotonEliminar && this.permisoBaja)
                ...
                {
                    System.Diagnostics.Debug.WriteLine($"[DEBUG-RECUPERAR] entidadAux es null para codigo={codigo}");
                }
            ...
            {
                mostrarError(exError.Message);
                System.Diagnostics.Debug.WriteLine($"[DEBUG-RECUPERAR] Exception: {exError.Message}");
            }
        }
        ...
        protected void frmBaseGrillaABM_Load(object sender, EventArgs e)
        {
            ...
            //Aqu� iba lo que est� en formularioLoad();
            formularioLoad();
        }
        ...
        protected virtual void modoEstatico(bool hayObjetoActivo)
        {
            ...
            // Control de visibilidad y habilitación para btnReplicar
            if (btnReplicar != null)
            {
                btnReplicar.Enabled = hayObjetoActivo;
                btnReplicar.Visible = hayObjetoActivo;
            }
        ...
        protected void inicializarGrilla(EntidadFactoryBase ef, string filtro, int top, string nombreSP)
        {
            try
            {
                ...
                //Si la grilla est� vac�a, pasa a modo est�tico
